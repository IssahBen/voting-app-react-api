...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference("Voter.count") do
      post voters_url, params: { voter: { ballot_id: @voter.ballot_id, first_name: @voter.first_name, last_name: @voter.last_name } }, as: :json
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { ballot_id: @voter.ballot_id, first_name: @voter.first_name, last_name: @voter.last_name } }, as: :json
    assert_response :success
  end
